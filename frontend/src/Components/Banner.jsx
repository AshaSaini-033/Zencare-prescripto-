  ...
  return (
    <div className='flex  bg-primary rounded-lg px-6 md:px-14 lg:px-12 my-20 md:mx-10 '>
      ...
      <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5'>
          ...
          <button className='bg-white text-sm sm:text-base text-gary-600 px-8 py-3 rounded-full mt-6 hover:scale-105 transition all' onClick={()=>{navigate('/login');scrollTo(0,0)}}> 
            Create Account
          </button>
      </div>
      {/* Right */}
